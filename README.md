...
|-------|------|------|-------------|-----------|
| 1 | A | Estrutura e tipos de teste | Uilson Alves dos Santos Neto | [docs/parte1-estrategia-estrutura.md](docs/parte1-estrategia-estrutura.md) |
...
| 6 | D | Plano de evolução da qualidade | Alícia Vitória Sousa Santos | [docs/parte6-plano-evolucao.md](docs/parte6-plano-evolucao.md) |

> Todas as seis partes desenvolvidas. Relatório consolidado para PDF: [docs/relatorio-atividade3.md](docs/relatorio-atividade3.md).
